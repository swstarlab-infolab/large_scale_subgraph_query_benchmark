...
COPY Comment_isLocatedIn_Country     FROM 'PATHVAR/Comment_isLocatedIn_Country.csv'    (DELIMITER '|', HEADER, FORMAT csv);
COPY Person_isLocatedIn_City         FROM 'PATHVAR/Person_isLocatedIn_City.csv'        (DELIMITER '|', HEADER, FORMAT csv);
COPY Post_isLocatedIn_Country        FROM 'PATHVAR/Post_isLocatedIn_Country.csv'       (DELIMITER '|', HEADER, FORMAT csv);
